...
ActiveRecord::Schema[7.0].define(version: 2022_08_01_092302) do
  create_table "accounts", id: { type: :string, limit: 36 }, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
